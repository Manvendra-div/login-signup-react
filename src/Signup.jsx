      ...
      <div className="bg-white p-6 rounded-md shadow-lg md:w-1/3">
        <form onSubmit={handleSubmit}>
          ...
          <div className="mb-4">
            <button
              type="submit"
              className="w-full px-4 py-2 text-white bg-blue-600 rounded-md hover:bg-blue-700 focus:outline-none focus:border-blue-700 focus:ring-blue-500 focus:ring-opacity-50"
            >
              Signup
            </button>
          </div>
